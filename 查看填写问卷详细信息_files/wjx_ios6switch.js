...
(function(){
	...
	var init = function(_elem, _opt){
		...
		_elem[0].checked == true && _switcher.find(".ios6switch_draglayer").css("left", ((_switcher.innerHeight() * 52 / 27) - _switcher.innerHeight()) + "px");
	...
	var setSize = function(te){
		...
		te.css("width", (te.innerHeight() * 52 / 27) + "px");
		...
		te.css("border-radius", (Math.ceil(te.outerHeight() / 2)) + "px");
