...
var s_account=(domain.indexOf("eonet.jp")>-1||domain.indexOf("mineo.jp")>-1||domain.indexOf("service3.eonet.ne.jp")>-1)?"kopticommineojp":"kopticommineojpdev";
if (domain.indexOf("test-my.mineo.jp") != -1 || domain.indexOf("test-my.eonet.jp") != -1 || domain.indexOf("test.mineo.jp") != -1 || domain.indexOf("qa.king.mineo.jp") != -1) s_account = "kopticommineojpdev";
...
s.linkInternalFilters="javascript:,eonet.jp,mineo.jp"
...
//	if(s.events.indexOf("event51")>-1){s.pageName = "mineo\u304A\u554F\u3044\u5408\u308F\u305B\u30D5\u30A9\u30FC\u30E0\uFF08\u5165\u529B\u753B\u9762\uFF09";}
//	if(s.events.indexOf("event52")>-1){s.pageName = "mineo\u304A\u554F\u3044\u5408\u308F\u305B\u30D5\u30A9\u30FC\u30E0\uFF08\u78BA\u8A8D\u753B\u9762\uFF09";}
//	if(s.events.indexOf("event53")>-1){s.pageName = "mineo\u304A\u554F\u3044\u5408\u308F\u305B\u30D5\u30A9\u30FC\u30E0\uFF08\u5B8C\u4E86\u753B\u9762\uFF09";}
...
//20151216 D=gが現在のURLを示さないケースがあるため、修正
...
/*events value*/1
if(s.prop1.indexOf("/tctrp/mk/mka01/MKA01V140.jsp")>-1||s.prop1.indexOf("/tctrp/mo/moa01/MOA01V140.jsp")>-1){s.events=s.events!=""&&typeof(s.events)!= 'undefined'?s.events+",event2":"event2";
}else if(s.prop1.indexOf("/tctrp/mk/mka01/MKA01V160.jsp")>-1||s.prop1.indexOf("/tctrp/mo/moa01/MOA01V160.jsp")>-1){s.events=s.events!=""&&typeof(s.events)!= 'undefined'?s.events+",event3":"event3";
}else if(s.prop1.indexOf("/tctrp/mk/mka01/MKA01V170.jsp")>-1||s.prop1.indexOf("/tctrp/mo/moa01/MOA01V170.jsp")>-1){s.events=s.events!=""&&typeof(s.events)!= 'undefined'?s.events+",event4":"event4";
}else if(s.prop1.indexOf("/prtct/mk/mka01/MKA01V180.jsp")>-1||s.prop1.indexOf("/prtct/mo/moa01/MOA01V180.jsp")>-1){s.events=s.events!=""&&typeof(s.events)!= 'undefined'?s.events+",event5":"event5";
}else if(s.pageName == "\u63D0\u4F9B\u6761\u4EF6\u306E\u3054\u78BA\u8A8D\uFF0D\u63D0\u4F9B\u6761\u4EF6\uFF08\u91CD\u8981\u4E8B\u9805\uFF09\u3068\u30B5\u30FC\u30D3\u30B9\u306E\u3054\u78BA\u8A8D"){s.events=s.events!=""&&typeof(s.events)!= 'undefined'?s.events+",event6":"event6";
}else if(s.pageName == "\u304A\u7533\u3057\u8FBC\u307F\u3092\u53D7\u3051\u4ED8\u3051\u307E\u3057\u305F"){s.events=s.events!=""&&typeof(s.events)!= 'undefined'?s.events+",event7,purchase":"event7,purchase";
}
...
/* valiable clear 20160531 */
s.clearVars = function() {
	var s = this;
	for (var k in s) {
		if ( /^(prop|eVar|hier|list)[0-9]+$/.test(k)
			|| /^(channel|events|products|purchaseID|transactionID|state|zip|campaign|pageName|isPageSet|pageURL)$/.test(k)) {
			s[k] = undefined;
		}
	}
};
...
s.trackingServer="kopticom.d2.sc.omtrdc.net"
